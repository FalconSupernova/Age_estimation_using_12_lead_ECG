...
from new_resnet_Jainik_model_domain_adaptation_3 import ResNet1d 
...
def create_scatter_plot(true_labels, final_predicted_ages, folder):
    ...
    # Add a diagonal line
    x = np.linspace(np.min(final_predicted_ages), np.max(true_labels), 100)
...
plot_loss(train_loss_list, valid_loss_list, folder, epochs)
