...
# loading data from source domain
    ...
    ECG_path = DB_path+'records500/'  # we will use the 100Hz recording version.
...
# transforming data and doing test train validation split of source domain
    ...
    source_domain_train, source_domain_test = train_test_split(ecg_source_domain, 0.90)
...
# loading and transforming data and test train split of target domain
    ...
    target_domain_train, target_domain_test = train_test_split(ecg_target_domain, ratio = 0.9) 
    tqdm.write("Done!")
...
for epoch in range(epochs):
    ...
    #valid_loss_list.append(valid_MAE)
